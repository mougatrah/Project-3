...
router
  .route("/api/user/update").put(function (req, res) {
    db.Auths.update(
...
router
  .route("/api/users").get(function (req, res) {
...
router
  .route("/api/user/:id").get(function (req, res) {
    db.Auths.findOne({
      where: {
        id: req.param.id
      }
...
router
  .route("/api/user/login").get(function (req, res) {
    db.Auths.findOne({
      where: {
...
router
  .route("/api/projects/all").get(function (req, res) {
...
router
  .route("/api/projects/favorites").get(function (req, res) {
...
router
  .route("/api/projects/topfive").get(function (req, res) {
    db.Projects.findAll({
      limit: 5,
...
router
  .route("/api/projects/search/:q").get(function (req, res) {
    db.Projects.findAll({
      where: {
        $or: [
...
router
  .route("/api/project/:id").get(function (req, res) {
    db.Projects.findOne({
      where: {
        id: req.params.id
      }
...
router
  .route("/api/comments").post(function (req, res) {
...
router
  .route("/api/comments/:id").get(function (req, res) {
    if (req.params.id) {
      db.Projects.findOne({
        where: {
          id: req.params.id
